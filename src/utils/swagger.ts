...
function crudPaths(path: string, tag: string, schemaRef: string) {
...
export const swaggerSpec = {
  ...
  paths: {
    ...
    ...crudPaths("categories", "categories", "Category"),
    ...crudPaths("locations", "locations", "Location"),
    ...crudPaths("events", "events", "Event"),
    ...crudPaths("tickets", "tickets", "Ticket"),
    ...crudPaths("orders", "orders", "Order"),
    ...crudPaths("banners", "banners", "Banner"),
  },
  components: {
    schemas,
    securitySchemes: {
